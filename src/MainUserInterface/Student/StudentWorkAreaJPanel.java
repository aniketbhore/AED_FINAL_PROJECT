 ...
 */
package MainUserInterface.Student;
...
public class StudentWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public StudentWorkAreaJPanel(JPanel userProcessContainer, User account, Ecosystem business) {
        initComponents();
    ...
    private void populateStudentInfo() {
        for (Student s : ecoSystem.getStudentDirectory().getStudentList()) {
            if (userAccount.getUsername().equals(s.getsUserName())) {
                txtFirstName.setText(s.getsFirstName());
                txtLastName.setText(s.getsLastName());
                txtAge.setText(Integer.toString(s.getsAge()));
                txtGender.setText(s.getsGender());
                txtAddress.setText(s.getsAddress());
                txtPhoneNumber.setText(s.getsPhoneNo());
                txtEmail.setText(s.getsEmailAddress());
                txtDateOfBirth.setText(new SimpleDateFormat("MM-dd-yyyy").format(s.getsdob()));
                txtDateOfAdmit.setText(new SimpleDateFormat("MM-dd-yyyy").format(s.getsDateOfAdmit()));
                txtInjuryType.setText(s.getsStudentType());
                txtBloodGroup.setText(s.getsBloodType());
                txtPatientStatus.setText(s.getsStatus());

                ImageIcon ii = new ImageIcon(s.getsImageUrl());
