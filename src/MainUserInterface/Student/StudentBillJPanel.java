 ...
 * @author nehashende
 */
public class StudentBillJPanel extends javax.swing.JPanel {

    /**
     * Creates new form StudentBillJPanel
     */
    JPanel userProcessContainer;
    Student s;
    
    public StudentBillJPanel(JPanel userProcessContainer, Student p) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.s = p;
        lblPatientName.setText(s.getsFirstName() + " " + s.getsLastName());
        populateBillTable();
    }
