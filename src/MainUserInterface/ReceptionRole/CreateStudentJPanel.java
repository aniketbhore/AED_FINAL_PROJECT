...
public class CreateStudentJPanel extends javax.swing.JPanel {
    ...
    public CreateStudentJPanel(JPanel userProcessContainer, Ecosystem system, User user) {
    ...
    private void initComponents() {
        ...
        lblRestaurantInfo.setText("Create Student");
        ...
        lblAccidentLocation.setText("Pick-Up Location");
        ...
        jLabel1.setText("Pick-Up Details");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if (ecoSystem.getUserAccountDirectory().checkIfUsernameIsUnique(txtUserName.getText())
            ...
            Student stud = new Student(txtUserName.getText());
            ...
            stud.setsBookStoreStatus("New Student");
            stud.setsInventoryStatus("New Student");
            stud.setsLabStatus("New Student");
            stud.setsStatus("New Student");
            stud.setsUserName(txtUserName.getText());
            stud.setsImageUrl(globalSelectedImagePath);
            stud.setsIsConcentFormSigned(IsconcentFormSigned);
...
//            }
            ...
            for (Student p : ecoSystem.getStudentDirectory().getStudentList()) {
                System.out.println("patient---"+p.getsFirstName());
            }
