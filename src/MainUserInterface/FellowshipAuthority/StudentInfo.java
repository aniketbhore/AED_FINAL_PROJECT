...
public class StudentInfo extends javax.swing.JPanel {
    ...
    public StudentInfo(JPanel userProcessContainer, Ecosystem business, Student p, User account) {
        initComponents();
        this.ecoSystem = business;
        this.userProcessContainer = userProcessContainer;
        this.stud= p;
        this.user = account;
        txtpFirstName.setText(p.getsFirstName());
        txtpLastName.setText(p.getsLastName());
        txtpAddress.setText(p.getsAddress());
        txtpAge.setText(Integer.toString(p.getsAge()));
        txtpGender.setText(p.getsGender());
        txtphInsuranceID.setText(p.getsFellowshipID());
        txtpNumber.setText(p.getsPhoneNo());
        txtpVerification.setText(p.getsPoliceStatus());
        try{
            String s = p.getsFellowshipID().substring(3,7)+"-"+p.getsFellowshipID().substring(7,9)+"-"+p.getsFellowshipID().substring(9,11);
            ...
            jLabel2.setText("Valid Fellowship");
            } 
            else{
                //System.out.print("Expired");
                jLabel3.setText("Fellowship Expired");
            }
        }
        catch(Exception e){
            jLabel3.setText("Invalid Fellowship ID");
        }
        jLabel4.setText("Bill Total: "+ecoSystem.getStudentDirectory().billTotal(stud));
        populateBillTable();
    }
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, 870, -1));
        add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 1392, 10));
        ...
        add(backBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 700, 130, 50));
        ...
        add(txtpFirstName, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 160, 150, 40));
        ...
        add(txtpLastName, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 220, 150, 40));

        lblpHealthInsuranceID.setBackground(new java.awt.Color(255, 255, 255));
        lblpHealthInsuranceID.setFont(new java.awt.Font("Georgia", 1, 18)); // NOI18N
        lblpHealthInsuranceID.setForeground(new java.awt.Color(255, 255, 255));
        lblpHealthInsuranceID.setText("Fellowship Id");
        add(lblpHealthInsuranceID, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, 130, -1));
        ...
        add(txtphInsuranceID, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 280, 150, 40));
        ...
        add(lblpAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 350, 76, 18));
        ...
        add(txtpAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, 150, 40));
        ...
        lblpAge.setText("Age");
        add(lblpAge, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 410, 50, -1));
        ...
        add(txtpAge, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 400, 150, 40));
        ...
        lblpVerification.setText("NUPD Verification");
        add(lblpVerification, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 470, 170, -1));
        ...
        add(txtpVerification, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 460, 150, 40));
        ...
        add(lblpGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 520, 70, 30));

        txtpGender.setEditable(false);
        add(txtpGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 520, 150, 40));
        ...
        add(lblpPhone, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 580, -1, 30));
        ...
        add(txtpNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 580, 150, 40));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 150, 720, 280));
        ...
        add(aprvBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 470, 140, 50));
        ...
        add(verificationBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 620, 220, 50));
        ...
        add(rjctBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 540, 150, 50));
    ...
    private void aprvBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aprvBtnActionPerformed
        // TODO add your handling code here:
        stud.setsFellowshipStatus("Approved");
        try{
    ...
    private void verificationBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verificationBtnActionPerformed
        // TODO add your handling code here:
        if(stud.getsPoliceStatus().equals("Verifying")||stud.getsPoliceStatus().equals("Verified")||stud.getsPoliceStatus().equals("Rejected")){
            JOptionPane.showMessageDialog(null, "Already verifying/Verified.");
        }
        else{
            stud.setsPoliceStatus("Verifying");
            ecoSystem.getPoliceRecords().addtoRecord(stud);
                    //getPoliceRecords().addtoRecord(sv);
            txtpVerification.setText(stud.getsPoliceStatus());
        }
