...
public class UpdateTeacherJPanel extends javax.swing.JPanel {
    ...
    User userAccount;
    Teacher t;
    public UpdateTeacherJPanel(JPanel userProcessContainer,User user, Ecosystem system, Teacher t) {
        initComponents();
        this.userAccount = user;
        this.userProcessContainer = userProcessContainer;
        this.ecoSystem = system;
        this.t=t;
        txtAddress.setText(t.gettAddress());
        txtAge.setText(Integer.toHexString(t.gettAge()));
        //txtDateOfBirth.setText(d.getDateofBirth());
        txtDoctorID.setText(t.gettWorkID());
        txtEmail.setText(t.gettEmail());
        txtExperience.setText(t.gettExperience());
        txtFirstName.setText(t.gettFirstName());
        txtLastName.setText(t.gettLastName());
        txtGender.setText(t.gettGender());
        txtPhoneNumber.setText(t.gettPhoneNumber());
        txtSpecialist.setText(t.gettSpecialization());
        txtUsername.setText(t.gettUserName());
    }
    /**
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        // TODO add your handling code here:
         t.settFirstName(txtFirstName.getText());
        t.settLastName(txtLastName.getText());
        t.settAge(Integer.parseInt( txtAge.getText()));
        t.settGender(txtGender.getText());
        t.settWorkID(txtDoctorID.getText());
        t.settAddress(txtAddress.getText());
        t.settPhoneNumber(txtPhoneNumber.getText());
        //doctor.setDateofBirth(txtDateOfBirth.getText());
        t.settEmail(txtEmail.getText());
        t.settSpecialization(txtSpecialist.getText());
        t.settExperience(txtExperience.getText());
