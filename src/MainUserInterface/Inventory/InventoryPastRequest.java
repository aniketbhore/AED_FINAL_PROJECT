 ...
 * @author JANVI
 */
public class InventoryPastRequest extends javax.swing.JPanel {

    /**
     * Creates new form InventoryPastRequest
     */
    Student stud;
    ...
    public InventoryPastRequest(JPanel userProcessContainer, User account, Student s,Ecosystem ecoSystem) {
        initComponents();
       ...
       for (StudentBills b : stud.getsBills()) {
           ...
           if(b.getOrgType().equals("Inventory")&&b.getStatus().equals("Delivered")){
